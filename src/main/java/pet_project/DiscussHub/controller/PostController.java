...
import static pet_project.DiscussHub.constant.AppConstants.POST_LINK;
...
public class PostController {
  ...
  public ResponseEntity<PostResponse> getById(
      @Parameter(description = "ID of the post to be retrieved") @PathVariable(name = "id")
          UUID id) {
  ...
  @PreAuthorize("@securityUtils.isAuthor(#id, authentication) or hasRole('ROLE_ADMIN')")
  @DeleteMapping("/{id}")
  @Operation(summary = "Delete a post", description = "Deletes a post based on the provided ID.")
